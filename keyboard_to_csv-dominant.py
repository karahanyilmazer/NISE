...
# %%
curr_path = os.getcwd()
data_path = r'/home/muhammed/Desktop/NISE/csv_data/keyboard/dominant'
os.chdir(data_path)
run_num = sum("keyboard_dominant" in f_name for f_name in os.listdir()) + 1
...
with open(f'keyboard_dominant_{run_num}.csv', mode='w', newline='') as file:
